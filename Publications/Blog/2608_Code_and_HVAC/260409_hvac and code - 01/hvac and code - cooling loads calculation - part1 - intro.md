...
Autor: "Donchenko Michail",  date: 2026-03-26,
___ 
...
The total cooling load for a building is the sum of heat gains from several sources:
- solar radiation through windows;
- heat emitted by occupants;
- heat from electronic equipment;
- heat generated by electric lighting.

These heat gains vary throughout the day due to:
- occupancy schedules and activity levels;
- solar position (altitude and azimuth), which directly affects solar radiation intensity.

To achieve accurate results, engineers perform **hourly calculations** for a typical day. These data then serve as the foundation for designing an efficient cooling system.
